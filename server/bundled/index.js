...
function parseHostedNetworkInfo(output) {
    const normalized = (output || "").replace(/\r/g, "");
    const clientMacAddresses = new Set();
    let status = null;
    let clientCount = 0;
    for (const rawLine of normalized.split("\n")) {
        ...
        const macMatch = line.match(/client mac address\s*:\s*([0-9a-f]{2}(?:[:-][0-9a-f]{2}){5})/i);
        if (macMatch?.[1]) {
            const normalizedMac = normalizeMac(macMatch[1]);
            if (normalizedMac)
                clientMacAddresses.add(normalizedMac);
        }
    }
    return {
        status,
...
const getConnectedDevices = async () => {
    try {
        const hostedNetworkResult = await (0,exec/* run */.e)("netsh wlan show hostednetwork");
        const hostedNetworkInfo = parseHostedNetworkInfo(hostedNetworkResult.stdout || hostedNetworkResult.stderr || "");
        const clientMacAddresses = hostedNetworkInfo.clientMacAddresses;
        if (!clientMacAddresses.length)
            return [];
        const arpResult = await (0,exec/* run */.e)("arp -a");
        const arpEntries = parseArpEntries(arpResult.stdout || arpResult.stderr || "");
        const devices = await Promise.all(clientMacAddresses.map(async (mac) => {
            ...
            const displayName = buildDisplayName(hostname, manufacturer, deviceType);
            return {
                ip,
                mac,
                hostname,
...
var Negotiator = __nccwpck_require__(2560)
var mime = __nccwpck_require__(1772)
...
var bind = __nccwpck_require__(917);

var $apply = __nccwpck_require__(4050);
var $call = __nccwpck_require__(3236);
var $reflectApply = __nccwpck_require__(2343);
...
var bind = __nccwpck_require__(917);
var $TypeError = __nccwpck_require__(9681);

var $call = __nccwpck_require__(3236);
var $actualApply = __nccwpck_require__(6832);
...
var GetIntrinsic = __nccwpck_require__(6661);

var callBindBasic = __nccwpck_require__(2734);
...
(function () {
  ...
  var assign = __nccwpck_require__(8357);
  var vary = __nccwpck_require__(5841);
...
module.exports = __nccwpck_require__(2938)(exports);
...
function setup(env) {
	...
	createDebug.humanize = __nccwpck_require__(7291);
...
if (typeof process === 'undefined' || process.type === 'renderer' || process.browser === true || process.__nwjs) {
	module.exports = __nccwpck_require__(9223);
} else {
...
var callBind = __nccwpck_require__(2734);
var gOPD = __nccwpck_require__(4450);
...
module.exports = __nccwpck_require__(5053);
...
var finalhandler = __nccwpck_require__(6593);
var debug = __nccwpck_require__(995)('express:application');
var View = __nccwpck_require__(1060);
var http = __nccwpck_require__(7067);
var methods = (__nccwpck_require__(5056)/* .methods */ .vX);
var compileETag = (__nccwpck_require__(5056)/* .compileETag */ .Rx);
var compileQueryParser = (__nccwpck_require__(5056)/* .compileQueryParser */ .HD);
var compileTrust = (__nccwpck_require__(5056)/* .compileTrust */ .y6);
var resolve = (__nccwpck_require__(6760).resolve);
var once = __nccwpck_require__(5491)
var Router = __nccwpck_require__(7359);
...
var bodyParser = __nccwpck_require__(3989)
var EventEmitter = (__nccwpck_require__(8474).EventEmitter);
var mixin = __nccwpck_require__(1179);
var proto = __nccwpck_require__(7427);
var Router = __nccwpck_require__(7359);
var req = __nccwpck_require__(528);
var res = __nccwpck_require__(6141);
...
exports["static"] = __nccwpck_require__(1264);
...
var accepts = __nccwpck_require__(4315);
var isIP = (__nccwpck_require__(7030).isIP);
var typeis = __nccwpck_require__(6950);
var http = __nccwpck_require__(7067);
var fresh = __nccwpck_require__(2529);
var parseRange = __nccwpck_require__(6261);
var parse = __nccwpck_require__(7544);
var proxyaddr = __nccwpck_require__(9468);
...
var contentDisposition = __nccwpck_require__(9497);
var createError = __nccwpck_require__(4360)
var deprecate = __nccwpck_require__(3397)('express');
var encodeUrl = __nccwpck_require__(491);
var escapeHtml = __nccwpck_require__(4723);
var http = __nccwpck_require__(7067);
var onFinished = __nccwpck_require__(7988);
var mime = __nccwpck_require__(1772)
var path = __nccwpck_require__(6760);
var pathIsAbsolute = (__nccwpck_require__(6760).isAbsolute);
var statuses = __nccwpck_require__(7443)
var sign = (__nccwpck_require__(5824).sign);
var normalizeType = (__nccwpck_require__(5056)/* .normalizeType */ .AZ);
var normalizeTypes = (__nccwpck_require__(5056)/* .normalizeTypes */ .Zs);
var setCharset = (__nccwpck_require__(5056)/* .setCharset */ .Jm);
var cookie = __nccwpck_require__(1668);
var send = __nccwpck_require__(8497);
...
var contentType = __nccwpck_require__(5611);
var etag = __nccwpck_require__(7243);
var mime = __nccwpck_require__(1772)
var proxyaddr = __nccwpck_require__(9468);
var qs = __nccwpck_require__(8160);
...
var debug = __nccwpck_require__(995)('express:view');
var path = __nccwpck_require__(6760);
...
var debug = __nccwpck_require__(995)('finalhandler')
var encodeUrl = __nccwpck_require__(491)
var escapeHtml = __nccwpck_require__(4723)
var onFinished = __nccwpck_require__(7988)
var parseUrl = __nccwpck_require__(7544)
var statuses = __nccwpck_require__(7443)
...
var implementation = __nccwpck_require__(5067);
...
var $Object = __nccwpck_require__(7203);

var $Error = __nccwpck_require__(2685);
var $EvalError = __nccwpck_require__(4447);
var $RangeError = __nccwpck_require__(8552);
var $ReferenceError = __nccwpck_require__(8012);
var $SyntaxError = __nccwpck_require__(7466);
var $TypeError = __nccwpck_require__(9681);
var $URIError = __nccwpck_require__(8983);

var abs = __nccwpck_require__(1781);
var floor = __nccwpck_require__(4215);
var max = __nccwpck_require__(4383);
var min = __nccwpck_require__(7509);
var pow = __nccwpck_require__(1199);
var round = __nccwpck_require__(8953);
var sign = __nccwpck_require__(5392);
...
var $gOPD = __nccwpck_require__(4450);
var $defineProperty = __nccwpck_require__(8231);
...
var hasSymbols = __nccwpck_require__(4827)();

var getProto = __nccwpck_require__(101);
var $ObjectGPO = __nccwpck_require__(7021);
var $ReflectGPO = __nccwpck_require__(919);
...
var bind = __nccwpck_require__(917);
var hasOwn = __nccwpck_require__(9449);
...
var reflectGetProto = __nccwpck_require__(919);
var originalGetProto = __nccwpck_require__(7021);

var getDunderProto = __nccwpck_require__(643);
...
/** @type {import('.')} */
var $gOPD = __nccwpck_require__(6150);
...
var hasSymbolSham = __nccwpck_require__(1145);
...
var deprecate = __nccwpck_require__(3397)('http-errors')
var setPrototypeOf = __nccwpck_require__(310)
var statuses = __nccwpck_require__(7443)
var inherits = __nccwpck_require__(9709)
var toIdentifier = __nccwpck_require__(9991)
...
var Buffer = (__nccwpck_require__(3973).Buffer)
...
module.exports = {
  ...
  shiftjis: {
    type: "_dbcs",
    table: function () { return __nccwpck_require__(9055) },
    encodeAdd: { "\u00a5": 0x5C, "\u203E": 0x7E },
  ...
  eucjp: {
    type: "_dbcs",
    table: function () { return __nccwpck_require__(2926) },
    encodeAdd: { "\u00a5": 0x5C, "\u203E": 0x7E }
  },
  ...
  cp936: {
    type: "_dbcs",
    table: function () { return __nccwpck_require__(5296) }
  },

  // GBK (~22000 chars) is an extension of CP936 that added user-mapped chars and some other.
  gbk: {
    type: "_dbcs",
    table: function () { return (__nccwpck_require__(5296).concat)(__nccwpck_require__(3522)) }
  },
  xgbk: "gbk",
  isoir58: "gbk",
  ...
  gb18030: {
    type: "_dbcs",
    table: function () { return (__nccwpck_require__(5296).concat)(__nccwpck_require__(3522)) },
    gb18030: function () { return __nccwpck_require__(3057) },
    encodeSkipVals: [0x80],
    encodeAdd: { "€": 0xA2E3 }
  },
  ...
  cp949: {
    type: "_dbcs",
    table: function () { return __nccwpck_require__(9270) }
  },
  ...
  cp950: {
    type: "_dbcs",
    table: function () { return __nccwpck_require__(4476) }
  },
  ...
  big5hkscs: {
    type: "_dbcs",
    table: function () { return (__nccwpck_require__(4476).concat)(__nccwpck_require__(7323)) },
    encodeSkipVals: [
...
var mergeModules = __nccwpck_require__(3931)

// Update this array if you add/rename/remove files in this directory.
// We support Browserify by skipping automatic module discovery and requiring modules directly.
var modules = [
  __nccwpck_require__(6189),
  __nccwpck_require__(2174),
  __nccwpck_require__(8144),
  __nccwpck_require__(7914),
  __nccwpck_require__(2120),
  __nccwpck_require__(4392),
  __nccwpck_require__(3408),
  __nccwpck_require__(7195),
  __nccwpck_require__(2181)
]
...
var bomHandling = __nccwpck_require__(927)
var mergeModules = __nccwpck_require__(3931)
...
module.exports.getCodec = function getCodec (encoding) {
  if (!module.exports.encodings) {
    var raw = __nccwpck_require__(2402)
...
module.exports.enableStreamingAPI = function enableStreamingAPI (streamModule) {
  ...
  var streams = __nccwpck_require__(4510)(streamModule)
...
try {
  ...
  /* istanbul ignore next */
  module.exports = __nccwpck_require__(9190);
}
...
var $isNaN = __nccwpck_require__(4272);
...
var db = __nccwpck_require__(3537)
var extname = (__nccwpck_require__(6928).extname)
var mimeScore = __nccwpck_require__(8362)
...
var preferredCharsets = __nccwpck_require__(4540)
var preferredEncodings = __nccwpck_require__(1515)
var preferredLanguages = __nccwpck_require__(4732)
var preferredMediaTypes = __nccwpck_require__(6204)
...
var utilInspect = __nccwpck_require__(8176);
...
var first = __nccwpck_require__(9216)
...
var wrappy = __nccwpck_require__(9891)
...
var forwarded = __nccwpck_require__(2089)
var ipaddr = __nccwpck_require__(7568)
...
var stringify = __nccwpck_require__(1309);
var parse = __nccwpck_require__(7587);
var formats = __nccwpck_require__(1488);
...
var utils = __nccwpck_require__(6121);
...
var getSideChannel = __nccwpck_require__(7916);
var utils = __nccwpck_require__(6121);
var formats = __nccwpck_require__(1488);
var has = Object.prototype.hasOwnProperty;
...
var asyncHooks = tryRequireAsyncHooks()
var bytes = __nccwpck_require__(9653)
var createError = __nccwpck_require__(4360)
var iconv = __nccwpck_require__(5663)
var unpipe = __nccwpck_require__(4632)
...
const isPromise = __nccwpck_require__(8579)
const Layer = __nccwpck_require__(226)
const { METHODS } = __nccwpck_require__(7067)
const parseUrl = __nccwpck_require__(7544)
const Route = __nccwpck_require__(5226)
const debug = __nccwpck_require__(995)('router')
const deprecate = __nccwpck_require__(3397)('router')
...
const isPromise = __nccwpck_require__(8579)
const pathRegexp = __nccwpck_require__(4422)
const debug = __nccwpck_require__(995)('router:layer')
const deprecate = __nccwpck_require__(3397)('router')
...
const debug = __nccwpck_require__(995)('router:route')
const Layer = __nccwpck_require__(226)
const { METHODS } = __nccwpck_require__(7067)
...
var createError = __nccwpck_require__(4360)
var debug = __nccwpck_require__(995)('send')
var encodeUrl = __nccwpck_require__(491)
var escapeHtml = __nccwpck_require__(4723)
var etag = __nccwpck_require__(7243)
var fresh = __nccwpck_require__(2529)
...
var mime = __nccwpck_require__(1772)
var ms = __nccwpck_require__(7291)
var onFinished = __nccwpck_require__(7988)
var parseRange = __nccwpck_require__(6261)
...
var inspect = __nccwpck_require__(9100);
...
var GetIntrinsic = __nccwpck_require__(6661);
var callBound = __nccwpck_require__(4636);
var inspect = __nccwpck_require__(9100);
...
var callBound = __nccwpck_require__(4636);
var inspect = __nccwpck_require__(9100);
var getSideChannelMap = __nccwpck_require__(5807);
...
var $TypeError = __nccwpck_require__(9681);
var inspect = __nccwpck_require__(9100);
var getSideChannelList = __nccwpck_require__(9767);
var getSideChannelMap = __nccwpck_require__(5807);
var getSideChannelWeakMap = __nccwpck_require__(8010);
...
var codes = __nccwpck_require__(288)
...
var contentType = __nccwpck_require__(5555)
var mime = __nccwpck_require__(1772)
var typer = __nccwpck_require__(8193)
 ...
 * @public
 */
exports.json = __nccwpck_require__(45)

/**
 * Raw parser.
 * @public
 */
exports.raw = __nccwpck_require__(1129)

/**
 * Text parser.
 * @public
 */
exports.text = __nccwpck_require__(3604)

/**
 * URL-encoded parser.
 * @public
 */
exports.urlencoded = __nccwpck_require__(1862)
...
const createError = __nccwpck_require__(4360)
const getBody = __nccwpck_require__(6080)
const iconv = __nccwpck_require__(5663)
const onFinished = __nccwpck_require__(7988)
const zlib = __nccwpck_require__(8522)
const hasBody = (__nccwpck_require__(6950).hasBody)
const { getCharset } = __nccwpck_require__(8600)
...
const debug = __nccwpck_require__(995)('body-parser:json')
const read = __nccwpck_require__(441)
const { normalizeOptions } = __nccwpck_require__(8600)
...
const debug = __nccwpck_require__(995)('body-parser:raw')
const read = __nccwpck_require__(441)
const { normalizeOptions, passthrough } = __nccwpck_require__(8600)
...
const debug = __nccwpck_require__(995)('body-parser:text')
const read = __nccwpck_require__(441)
const { normalizeOptions, passthrough } = __nccwpck_require__(8600)
...
const createError = __nccwpck_require__(4360)
const debug = __nccwpck_require__(995)('body-parser:urlencoded')
const read = __nccwpck_require__(441)
const qs = __nccwpck_require__(8160)
const { normalizeOptions } = __nccwpck_require__(8600)
...
const bytes = __nccwpck_require__(9653)
const contentType = __nccwpck_require__(5555)
const typeis = __nccwpck_require__(6950)
